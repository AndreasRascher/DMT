codeunit 50049 DMTProcessTemplateLib
{
    ...
    var
        ...
        InStr: InStream;
        ResponseText: Text;
        downloadURLTok: Label 'https://github.com/AndreasRascher/DMT/raw/main/DMTNAVUpgradeHelper/src/ProcessTemplate/DefaultProcessTemplateSetup.xlsx', Locked = true;
        OutStr: OutStream;
    begin
