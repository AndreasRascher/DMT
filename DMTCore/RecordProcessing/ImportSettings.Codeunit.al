codeunit 50010 DMTImportSettings
{
    ...
    procedure init(processingPlanNEW: Record DMTProcessingPlan)
    var
        importConfigHeaderFound: Record DMTImportConfigHeader;
    begin
        ...
        if processingPlanNEW.findImportConfigHeader(importConfigHeaderFound) then
            ImportConfigHeader(importConfigHeaderFound);
    ...
    procedure RecordsToProcessLimit(): Integer
    begin
