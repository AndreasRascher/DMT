...
//             repeat
//                 isReplacment := iGloblalReplacementHandler.HasReplacementsForTargetField(importConfigLine."Target Field No.");
//                 if isReplacment then begin
//                     sourceValue := format(iGloblalReplacementHandler.GetReplacementValue(importConfigLine."Target Field No.").Value);
//                 end else begin
//                     sourceValue := format(GlobalBufferRef.Field(importConfigLine."Source Field No.").Value);
//                 end;
//                 addProcessingStep(importConfigLine, sourceValue, isReplacment);
...
//             SetProcessingSteps(ProcessingSteps, Format(CurrStepType::InsertRecord_WithTrigger), '', false, importConfigLine.RecordId);
//         end else begin
//             SetProcessingSteps(ProcessingSteps, format(CurrStepType::InsertRecord), '', false, importConfigLine.RecordId);
//         end;
//     end;

//     local procedure SetProcessingSteps(var processingStepsNEW: List of [List of [Text]]; currStepTypeText: Text; sourceValue: Text; isReplacment: Boolean; RecordId: RecordId)
//     var
//         innerList: List of [Text];
//     begin
//         innerList.AddRange(Format(currStepTypeText, 0, '<Text>'), sourceValue, Format(isReplacment, 0, 9), Format(RecordId, 0, 9));
//         processingStepsNEW.Add(innerList);
//     end;

//     local procedure GetProcessingStep(var currStepTypeNEW: Option; var sourceValue: Text; var isReplacement: Boolean; var RecordId: RecordId; var processingStepsNEW: List of [List of [Text]]) OK: Boolean
//     var
//         innerList: List of [Text];
//     begin
...
//         // SourceValue
//         sourceValue := innerList.Get(2);
//         // IsReplacement
//         Evaluate(isReplacement, innerList.Get(3), 9);
//         // RecordId
//         Evaluate(RecordId, innerList.Get(4), 9);
//         exit(true);
//     end;
...
//         sourceValue: Text;
//         isReplacment: Boolean;
//         replacementLbl: Label 'Replacement', Comment = 'de-DE=Ersetzung';
//     begin
//         Clear(SourceDescription);
//         Clear(TargetDescription);
//         Clear(stepType);
//         Clear(sourceType);
//         if not GetProcessingStep(stepType, sourceValue, isReplacment, recID, ProcessingSteps) then
//             exit(false);
...
//                     if isReplacment then
//                         SourceDescription := replacementLbl;
...
//     local procedure addProcessingStep(var importConfigLine: record DMTImportConfigLine; sourceValue: Text; isReplacment: Boolean)
//     begin
...
//                             SetProcessingSteps(ProcessingSteps, Format(CurrStepType::Field_Validate), sourceValue, isReplacment, importConfigLine.RecordId);
//                         Enum::DMTFieldValidationType::AssignWithoutValidate:
//                             SetProcessingSteps(ProcessingSteps, format(CurrStepType::Field_Assign), sourceValue, isReplacment, importConfigLine.RecordId);
//                         Enum::DMTFieldValidationType::ValidateOnlyIfNotEmpty:
//                             SetProcessingSteps(ProcessingSteps, format(CurrStepType::Field_ValidateIfNotEmpty), sourceValue, isReplacment, importConfigLine.RecordId);
//                     end;
//                 end;
...
//                     case importConfigLine."Validation Type" of
//                         Enum::DMTFieldValidationType::AlwaysValidate:
//                             SetProcessingSteps(ProcessingSteps, format(CurrStepType::FixedValue_ValidateValue), sourceValue, isReplacment, importConfigLine.RecordId);
//                         Enum::DMTFieldValidationType::AssignWithoutValidate:
//                             SetProcessingSteps(ProcessingSteps, format(CurrStepType::FixedValue_AssignValue), sourceValue, isReplacment, importConfigLine.RecordId);
//                         Enum::DMTFieldValidationType::ValidateOnlyIfNotEmpty:
//                             SetProcessingSteps(ProcessingSteps, format(CurrStepType::FixedValue_ValidateIfNotEmpty), sourceValue, isReplacment, importConfigLine.RecordId);
//                     end;
//                 end;
//         end;
//     end;
