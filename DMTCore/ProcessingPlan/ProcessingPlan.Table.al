table 91009 DMTProcessingPlan
{
    ...
    begin
        ...
        fixedValueText := TempImportConfigLine."Default Value";
        ...
        TempImportConfigLine."Default Value" := CopyStr(fixedValueText, 1, MaxStrLen(TempImportConfigLine."Default Value"));
    end;
